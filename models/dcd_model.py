...
class DCDModel(BaseModel):
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--f', type=float, default=1.0, help='weight for L1 loss')
...
class Butterworth(nn.Module):
    def __init__(self):
        super(Butterworth, self).__init__()
...
class perceptual(nn.Module):
    def __init__(self):
        ...
        self.model = models.vgg16(pretrained=True).features[0:3]
        self.model.eval()
        self.model.cuda()
